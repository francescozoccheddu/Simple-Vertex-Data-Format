...
#define C4D2GL_BAD_VERT_DATA (4 | C4D2GL_FORMAT_ERROR_BIT)
#define C4D2GL_BAD_IND_DATA (5 | C4D2GL_FORMAT_ERROR_BIT)
#define C4D2GL_UNEXPECTED_TAIL (6 | C4D2GL_FORMAT_ERROR_BIT)
