...
{
	return RegisterCommandPlugin (ExportCommand::id, GeLoadString(IDS_EXPORT_COMMAND_TITLE), 0, nullptr, GeLoadString(IDS_EXPORT_COMMAND_HELP), NewObj (ExportCommand));
}
